...
public class DefaultSheepTypes {
    public static List<SheepTypeData> getDefaults() {
        ...
        // Cobblestone
        DefaultSheep.add(new SheepTypeData("cobblestone", "#808080", "#555555",List.of(), List.of(
        ...
        // Stone
        DefaultSheep.add(new SheepTypeData("stone", "#888888", "#555555",List.of(), List.of(
        ...
        // Sand
        DefaultSheep.add(new SheepTypeData("sand", "#f0d890", "#d2b56b",List.of(), List.of(
        ...
        // Dripstone
        DefaultSheep.add(new SheepTypeData("dripstone", "#c2b8a3", "#9e8f74",List.of(), List.of(
        ...
        // Granite
        DefaultSheep.add(new SheepTypeData("granite", "#d16b6b", "#9c4747",List.of(), List.of(
        ...
        // Diorite
        DefaultSheep.add(new SheepTypeData("diorite", "#c5c5c5", "#8a8a8a",List.of(), List.of(
        ...
        // Andesite
        DefaultSheep.add(new SheepTypeData("andesite", "#888888", "#666666",List.of(), List.of(
        ...
        DefaultSheep.add(new SheepTypeData("netherrack", "#5a2b2b", "#3d1d1d",List.of(
                "minecraft:crimson_fungus", "minecraft:crimson_roots","minecraft:warped_fungus", "minecraft:warped_roots"), List.of(
        ...
        // Coal
        DefaultSheep.add(new SheepTypeData("coal","#252525", "#101015",List.of(), List.of(
                new SheepTypeData.TierData(1,"minecraft:coal", 8, 13),
                new SheepTypeData.TierData(2,"minecraft:coal_block", 4, 8)
        )));

        // Iron
        DefaultSheep.add(new SheepTypeData("iron", "#D8D8D8", "#A0A0A0",List.of(), List.of(
        ...
        // Copper
        DefaultSheep.add(new SheepTypeData("copper", "#e77c56", "#8a4129",List.of(), List.of(
                new SheepTypeData.TierData(1,"minecraft:copper_ingot", 8, 14),
                new SheepTypeData.TierData(2,"minecraft:copper_block", 5, 9)
        )));

        // Redstone
        DefaultSheep.add(new SheepTypeData("redstone", "#FF0000", "#8B0000",List.of(), List.of(
                new SheepTypeData.TierData(1,"minecraft:redstone", 8, 13),
                new SheepTypeData.TierData(2,"minecraft:redstone_block", 4, 7)
        )));

        // Lapis Lazuli
        DefaultSheep.add(new SheepTypeData("lapis_lazuli", "#0042A3", "#002E8C",List.of(), List.of(
        ...
        DefaultSheep.add(new SheepTypeData("quartz", "#EAE5DE", "#D4CCC5",List.of(
                "minecraft:crimson_fungus", "minecraft:crimson_roots","minecraft:warped_fungus", "minecraft:warped_roots", "minecraft:wheat"), List.of(
                new SheepTypeData.TierData(1,"minecraft:quartz", 11, 17),
                new SheepTypeData.TierData(2,"minecraft:quartz_block", 8, 11)
        )));

        // Gold
        DefaultSheep.add(new SheepTypeData("gold", "#fdf55f", "#dc9613",List.of(), List.of(
        ...
        // Diamond
        DefaultSheep.add(new SheepTypeData("diamond", "#63F7F2", "#00E0D8",List.of(), List.of(
                new SheepTypeData.TierData(1,"minecraft:diamond", 1, 5),
                new SheepTypeData.TierData(2,"minecraft:diamond_block", 1, 3)
        )));

        // Emerald
        DefaultSheep.add(new SheepTypeData("emerald", "#00A82B", "#008C23",List.of(), List.of(
